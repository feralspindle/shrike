...
def init_driven_runtime(compute_workers: int) -> bool: ...
def drive_io() -> None: ...
def drive_collection() -> None: ...
def drive_compute() -> None: ...
def drive_pools_shutdown() -> None: ...
def runtime_probe() -> None: ...
def runtime_metrics_json() -> str: ...
...
class AsyncKernel:
    def attach_embedder(
        ...
        unsafe_assume_normalized: bool = False,
    ) -> None: ...
...
class DerivedTextEngine:
    ...
    def search_fuzzy_batch(
        self, queries: list[str], top_k: int, scope: list[int] | None = None
    ) -> list[list[tuple[int, str, str, tuple[str, tuple[int, int]] | None]]]: ...
    ...
    def prune_policy(self) -> tuple[int, float, int, float, float]: ...
    def set_materialize_ceiling(self, ceiling: int) -> None: ...
    def materialize_ceiling(self) -> int: ...
