...
tests/
├── unit/                         # 540 tests — direct calls, no server
...
└── integration/                  # 203 tests — real server subprocess + HTTP transport
